...
DOCKER_TEST_DIR = os.path.join(DOCKER_MOUNT_DIR, "tests")

# finetune
DATA_DIR = os.path.join(DOCKER_MOUNT_DIR, "tests/assets/Belle_sampled_qwen.json")
DS_CONFIG_ZERO2_DIR = os.path.join(
    DOCKER_MOUNT_DIR, "tests/assets/ds_config_zero2.json"
)
DS_CONFIG_ZERO3_DIR = os.path.join(
    DOCKER_MOUNT_DIR, "tests/assets/ds_config_zero3.json"
)
